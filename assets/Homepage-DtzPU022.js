import"./main-Cp30K3D1.js";import"./date-Bl5-bMwz.js";function f(){const e=new Date,t=String(e.getHours()).padStart(2,"0"),d=String(e.getMinutes()).padStart(2,"0");document.getElementById("time").textContent=`${t}:${d}`}f();setInterval(f,1e3);document.querySelectorAll(".mood-img").forEach(e=>{e.style.cursor="pointer",e.addEventListener("click",()=>{const t={id:e.dataset.mood,label:e.dataset.label,src:e.getAttribute("src"),time:Date.now()};sessionStorage.setItem("selectedMood",JSON.stringify(t)),location.href="record.html"})});function x(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}(function(){const t=document.getElementById("journal-list"),d=document.getElementById("default-list");if(!t)return;const r=sessionStorage.getItem("latestRecord");if(!r)return;const n=JSON.parse(r),o=document.querySelector(`[data-mood="${n.moodId}"]`)||document.querySelector(`[value="${n.moodId}"]`),c=(o==null?void 0:o.dataset.srcB)||(o==null?void 0:o.getAttribute("src"))||"";d&&(d.style.display="none"),t.innerHTML=`
